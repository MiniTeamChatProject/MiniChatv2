...
type Bootstrap struct {
	...
	UserClient    *UserClient            `protobuf:"bytes,3,opt,name=userClient,proto3" json:"userClient,omitempty"`
...
func (x *Bootstrap) GetUserClient() *UserClient {
	if x != nil {
		return x.UserClient
	}
	return nil
...
type UserClient struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Addr          string                 `protobuf:"bytes,1,opt,name=addr,proto3" json:"addr,omitempty"` // User service gRPC address
...
func (x *UserClient) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *UserClient) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
type Server_HTTP struct {
	...
	Metadata      bool                   `protobuf:"varint,4,opt,name=metadata,proto3" json:"metadata,omitempty"` // Enable Swagger UI
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Server_HTTP) GetMetadata() bool {
	if x != nil {
		return x.Metadata
	}
	return false
...
type Data_Database struct {
	...
	EnableAutoMigrate bool                   `protobuf:"varint,6,opt,name=enable_auto_migrate,json=enableAutoMigrate,proto3" json:"enable_auto_migrate,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *Data_Database) GetEnableAutoMigrate() bool {
	if x != nil {
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\n" +
	"userClient\x18\x03 \x01(\v2\x16.kratos.api.UserClientR\n" +
	"userClient\"\xd5\x02\n" +
	"\x06Server\x12+\n" +
	"\x04http\x18\x01 \x01(\v2\x17.kratos.api.Server.HTTPR\x04http\x12+\n" +
	"\x04grpc\x18\x02 \x01(\v2\x17.kratos.api.Server.GRPCR\x04grpc\x1a\x85\x01\n" +
	"\x04HTTP\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x12\x1a\n" +
	"\bmetadata\x18\x04 \x01(\bR\bmetadata\x1ai\n" +
	"\x04GRPC\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xa1\x04\n" +
	"\x04Data\x125\n" +
	"\bdatabase\x18\x01 \x01(\v2\x19.kratos.api.Data.DatabaseR\bdatabase\x12,\n" +
	"\x05redis\x18\x02 \x01(\v2\x16.kratos.api.Data.RedisR\x05redis\x1a\xfd\x01\n" +
	"\bDatabase\x12\x16\n" +
	"\x06driver\x18\x01 \x01(\tR\x06driver\x12\x16\n" +
	"\x06source\x18\x02 \x01(\tR\x06source\x12$\n" +
	"\x0emax_open_conns\x18\x03 \x01(\x05R\fmaxOpenConns\x12$\n" +
	"\x0emax_idle_conns\x18\x04 \x01(\x05R\fmaxIdleConns\x12E\n" +
	"\x11conn_max_lifetime\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\x0fconnMaxLifetime\x12.\n" +
	"\x13enable_auto_migrate\x18\x06 \x01(\bR\x11enableAutoMigrate\x1a\xb3\x01\n" +
	"\x05Redis\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	...
	"\atimeout\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\atimeoutB\x19Z\x17room/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*UserClient)(nil),          // 3: kratos.api.UserClient
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 2: kratos.api.Bootstrap.userClient:type_name -> kratos.api.UserClient
	...
	8,  // 7: kratos.api.UserClient.timeout:type_name -> google.protobuf.Duration
